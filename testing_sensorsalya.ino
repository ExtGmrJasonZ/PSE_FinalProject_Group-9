...
void loop() {
  ...
  if (myBot.getNewMessage(msg)) {
    ...
    if (msg.text.equalsIgnoreCase("FAN ON")) {              // if the received message is "LIGHT ON"...
      Serial.print ("FAN ON");
    }
      ...
      String reply;
      reply = (String)"Welcome " + msg.sender.username + (String)". The commands are : LED ON, LED OFF, TEMPERATURE, HUMIDITY, MOISTURE AND STATUS. ";
